    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case RecipeIngredientsRow:
            return RecipeIngredientsRow(data);
          case IngredientsRow:
            return IngredientsRow(data);
          case UsersDataRow:
            return UsersDataRow(data);
          case ShoppingListRow:
            return ShoppingListRow(data);
          case RecipesRow:
            return RecipesRow(data);
          case InventoryExtendedRow:
            return InventoryExtendedRow(data);
          case RecipeIngredientsExtendedRow:
            return RecipeIngredientsExtendedRow(data);
          case ShoppingListExtendedRow:
            return ShoppingListExtendedRow(data);
          case FavoritesRow:
