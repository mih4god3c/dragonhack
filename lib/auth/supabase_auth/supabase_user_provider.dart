...
class DragonHackSupabaseUser extends BaseAuthUser {
  DragonHackSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> dragonHackSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = DragonHackSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
